...
// Importação dinâmica do componente MapView com SSR desativado
const DynamicMapView = dynamic(() => import("./map-view").then((mod) => mod.MapView), {
  ssr: false,
  loading: () => (
    <Card className="overflow-hidden">
      <div className="flex items-center justify-center bg-slate-100 h-[400px]">
...
export function MapLoader(props: MapLoaderProps) {
  ...
  return <DynamicMapView {...props} onMapError={handleMapError} />
}
