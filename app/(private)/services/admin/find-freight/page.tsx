...
const mockFreights = [
  {
    id: "FR-001",
    origin: "Lisboa",
    originProvince: "Lisboa",
    destination: "Porto",
    destinationProvince: "Porto",
    cargoType: "Alimentos",
    weight: "500 kg",
    ...
    price: "€350",
    description: "Carga refrigerada de frutas frescas.",
  ...
  },
  {
    id: "FR-002",
    origin: "Faro",
    originProvince: "Algarve",
    destination: "Setúbal",
    destinationProvince: "Setúbal",
    cargoType: "Peças Automóveis",
    weight: "1.200 kg",
    ...
    price: "€800",
    description: "Peças mecânicas embaladas.",
    clientName: "Oficina AutoPlus",
    clientRating: 4.5,
    status: "concluded"
  },
  {
    id: "FR-003",
    origin: "Braga",
    originProvince: "Braga",
    destination: "Coimbra",
    destinationProvince: "Coimbra",
    cargoType: "Eletrónicos",
    weight: "200 kg",
    ...
    price: "€500",
    description: "Caixas com equipamentos eletrónicos.",
...
export default function FindFreightPage() {
  ...
  if(val === "all") setFilteredFreights(mockFreights)
  else setFilteredFreights(mockFreights.filter(f => f.status === val))
}}>
                  <TabsList>
                    <TabsTrigger value="all">Todos</TabsTrigger>
                    <TabsTrigger value="active">Ativos</TabsTrigger>
                    <TabsTrigger value="concluded">Concluidos</TabsTrigger>
