...
export default function FindFreightPage() {
  ...
  const [filteredFreights, setFilteredFreights] = useState(null)
          ...
          {selectedFreight ? (
            <Card>
              ...
              <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{selectedFreight.originState}</p>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{selectedFreight.destinationState}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedFreight.weightKg}</p>
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground">Dimensões</p>
                    <p className="font-medium">{selectedFreight.lenghtCm + selectedFreight.heightCm + selectedFreight.widthCm}</p>
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground">Distância</p>
                    <p className="font-medium">{selectedFreight.estimatedDistance}</p>
                  </div>
                </div>
                ...
                <div className="bg-muted p-4 rounded-lg">
                  ...
                  <p className="text-sm">{selectedFreight.client.person.fullName}</p>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                ...
                <Button onClick={handleApply}>Aceitar</Button>
              </CardFooter>
            </Card>
          ) : (
            <>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold">Fretes Disponíveis ({filteredFreights && filteredFreights.length > 0})</h2>
              ...
              {filteredFreights && filteredFreights.length === 0 ? (
                <Card>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2 mb-4">
                              ...
                              <span className="text-xs text-muted-foreground">({freight.estimateDistance})</span>
                            </div>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              <div className="flex items-center gap-1">
                                <Weight className="h-4 w-4 text-muted-foreground" />
                                <span>{freight.weightKg}</span>
                              </div>
                              <div className="flex items-center gap-1">
